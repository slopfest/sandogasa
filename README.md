...
- **[dbranch](tools/dbranch/)** — propagate a Debian package across its Ubuntu/PPA branches in `rpmbuild`-style stages (merge + changelog rebuild entry; optional pbuilder build); doubles as a learning tool via `--explain`
